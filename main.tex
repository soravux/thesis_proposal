...
% In some cases, bleh
The analysis in our previous contributions showed that sometimes, even with the best possible surface with the lowest sensor noise, there is not enough photometric cue to recover certain normals or surfaces over the sphere.
