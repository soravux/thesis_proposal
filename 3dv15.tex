...
\begin{figure}[t]
\centering
\includegraphics[width=.5\columnwidth]{diagram_MLVshift3}
...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.52\linewidth]{./figures/realData/realData4.pdf}
